define({ "api": [
  ...
  {
    "type": "post",
    "url": "/api/auth/incomplete-profile",
    "title": "Get incomplete peddler profile",
    "name": "getAuthIncompleteProfile",
    "group": "Authentication_Peddler",
    "version": "1.0.0",
    "parameter": {
      "fields": {
        "Parameter": [
  ...
  },
  {
    ...
    "version": "1.0.0",
    "description": "<p>Endpoint to get feeds for products. The product Id is used to categorize feeds</p>",
    "filename": "src/api/routes/blog-post.js",
  ...
  {
    "type": "put",
    "url": "/api/user/peddler/driver/:driverId/delete",
    "title": "Delete Driver",
    "name": "postPeddlerDriverDelete",
    "group": "Driver_Management",
    "version": "1.0.0",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "driverId",
            "description": "<p>id of driver you want to delete</p>"
          }
        ]
      }
    },
    "description": "<p>This endpoint will delete a driver</p>",
    "filename": "src/api/routes/user/peddler.js",
    "groupTitle": "Driver_Management"
  },
  {
    "type": "put",
    "url": "/api/user/peddler/driver/:driverId/disable",
    "title": "Disable Driver",
    "name": "postPeddlerDriverDisable",
    "group": "Driver_Management",
    "version": "1.0.0",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "driverId",
            "description": "<p>id of driver you want to disable</p>"
          }
        ]
      }
    },
    "description": "<p>This endpoint will disbale a driver</p>",
    "filename": "src/api/routes/user/peddler.js",
    "groupTitle": "Driver_Management"
  },
  {
    "type": "put",
    "url": "/api/user/peddler/driver/:driverId/enable",
    "title": "Enable Driver",
    "name": "postPeddlerDriverEnable",
    "group": "Driver_Management",
    "version": "1.0.0",
    "parameter": {
      "fields": {
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "driverId",
            "description": "<p>id of driver you want to enable</p>"
          }
        ]
      }
    },
    "description": "<p>This endpoint will enable a driver</p>",
    "filename": "src/api/routes/user/peddler.js",
    "groupTitle": "Driver_Management"
  },
  {
  ...
  {
    "type": "get",
    "url": "/api/user/peddler/online-drivers",
    "title": "Retrieve Online drivers",
    "name": "getPeddlerOnlineDrivers",
    "group": "Peddler_-_Drivers",
    "version": "1.0.0",
    "description": "<p>Retreives all online drivers of a peddler</p>",
    "filename": "src/api/routes/user/peddler.js",
    "groupTitle": "Peddler_-_Drivers"
  },
  {
    "type": "get",
    "url": "/api/user/peddler/orders?status=pending+accepted&limit=30&page=1",
    "title": "Retrieve orders",
    "name": "getPeddlerOrders",
    "group": "Peddler_-_Order",
    "version": "1.0.0",
    "description": "<p>Return orders based on status (pending|accepted|completed|cancelled|inprogress) passed in the status query params. To return results with more than one status, seperate the status passed in the query with a plus symbol</p>",
    "parameter": {
      "fields": {
        "Parameter": [
          {
          ...
          },
          {
            ...
            "optional": true,
            "field": "page",
            "description": "<p>page number (query param)</p>"
          },
          {
            "group": "Parameter",
            "type": "Number",
            "optional": true,
            "field": "limit",
            "description": "<p>page limit (query Param)</p>"
          }
        ]
      }
    },
    "filename": "src/api/routes/user/peddler.js",
    "groupTitle": "Peddler_-_Order"
  },
  {
    "type": "get",
    "url": "/api/user/peddler/orders/:driverId?status=pending+accepted&limit=30&page=1",
    "title": "Retrieve orders of specific driver",
    "name": "getPeddlerDriverOrders",
    "group": "Peddler_-_Orders",
    "version": "1.0.0",
    "description": "<p>Return orders based on status (pending|accepted|completed|cancelled|inprogress) passed in the status query params. To return results with more than one status, seperate the status passed in the query with a plus (+) symbol</p>",
    "parameter": {
      "fields": {
  ...
  {
    "type": "get",
    "url": "/api/support/last-messages?limit=30&page=1",
    "title": "Get last messages",
    "name": "getLastSupportMessages",
    "group": "Support",
    "version": "1.0.0",
    "parameter": {
      "fields": {
    ...
    "description": "<p>Endpoint to get last messages</p>",
  ...
  {
    "type": "get",
    "url": "/api/support/messages?limit=30&page=1",
    "title": "Get messages",
    "name": "getSupportMessageAll",
    "group": "Support",
    "version": "1.0.0",
  ...
  {
    "type": "get",
    "url": "/api/support/messages/:userId?limit=30&page=1",
    "title": "Get messages of specific user",
    "name": "getUserSupportMessages",
    "group": "Support",
    "version": "1.0.0",
    "parameter": {
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "userId",
            "description": "<p>id of the user you want to fetch messages for</p>"
          }
        ]
      }
    },
    "description": "<p>Endpoint to get messages from specific users. This route can be accessed by admins alone</p>",
    "filename": "src/api/routes/support.js",
    "groupTitle": "Support"
  },
  {
